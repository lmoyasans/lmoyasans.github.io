(() => {
  // <stdin>
  (function($) {
    var $window = $(window), $body = $("body"), $wrapper = $("#wrapper"), $header = $("#header"), $nav = $("#nav"), $main = $("#main"), $navPanelToggle, $navPanel, $navPanelInner;
    breakpoints({
      default: ["1681px", null],
    ...
    $.fn._parallax = function(intensity) {
      ...
      $this.each(function() {
        ...
        on = function() {
          ...
          $window2.on("scroll._parallax", function() {
            var pos = parseInt($window2.scrollTop()) - parseInt($t.position().top);
            $bg.css("transform", "matrix(1,0,0,1,0," + pos * intensity + ")");
          });
        };
        off = function() {
          $bg.addClass("fixed").css("transform", "none");
          $window2.off("scroll._parallax");
        };
      ...
      $window2.off("load._parallax resize._parallax").on("load._parallax resize._parallax", function() {
